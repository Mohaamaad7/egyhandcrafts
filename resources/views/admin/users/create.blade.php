                    ...
                    <div class="row g-3 mb-3">
                        ...
                        <div class="col-md-5">
                            ...
                            <select name="role" id="role" class="form-select @error('role') is-invalid @enderror" required>
                                <option value="admin" {{ old('role') === 'admin' ? 'selected' : '' }}>مسؤول توثيق (Admin)</option>
                                <option value="super_admin" {{ old('role') === 'super_admin' ? 'selected' : '' }}>مدير النظام (Super Admin)</option>
                            </select>
                            @error('role')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
