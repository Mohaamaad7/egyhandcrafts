...
@section('page_title', 'إضافة ورشة جديدة')
...
<div class="container-xl">
    <div class="page-header d-print-none">
        <div class="row align-items-center">
            ...
            <div class="col">
                <h2 class="page-title">إضافة ورشة تراثية جديدة</h2>
            </div>
        </div>
    </div>
    ...
    <div class="card mt-3">
        <div class="card-header">
            <h3 class="card-title"><i class="ti ti-plus me-1"></i> بيانات الورشة</h3>
        </div>
        <div class="card-body">
            <form action="{{ route('admin.workshops.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                               value="{{ old('name') }}" placeholder="مثال: ورشة الإتحاد لصناعة الصدف" required>
                        @error('name')
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="craft_type" class="form-control @error('craft_type') is-invalid @enderror"
                               value="{{ old('craft_type') }}" placeholder="مثال: الصدف" required>
                        @error('craft_type')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="location" class="form-control @error('location') is-invalid @enderror"
                               value="{{ old('location') }}" placeholder="مثال: ساقية المنقدي" required>
                        @error('location')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="owner" class="form-control @error('owner') is-invalid @enderror"
                               value="{{ old('owner') }}" placeholder="مثال: محمود قوطة" required>
                        @error('owner')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="text" name="workers_count" class="form-control @error('workers_count') is-invalid @enderror"
                               value="{{ old('workers_count') }}" placeholder="مثال: 15-20" required>
                        @error('workers_count')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="text" name="phone" class="form-control @error('phone') is-invalid @enderror"
                               value="{{ old('phone') }}" placeholder="01020157157" dir="ltr" required>
                        @error('phone')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" name="latitude" id="latInput" step="0.0000001"
                               ...
                               value="{{ old('latitude') }}" placeholder="30.3793551" dir="ltr" required>
                        @error('latitude')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" name="longitude" id="lngInput" step="0.0000001"
                               ...
                               value="{{ old('longitude') }}" placeholder="30.8876568" dir="ltr" required>
                        @error('longitude')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="short_description" rows="3"
                                  ...
                                  placeholder="وصف مختصر عن الورشة (اختياري)">{{ old('short_description') }}</textarea>
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="content" id="content"
                                  ...
                                  placeholder="اكتب المحتوى الكامل لصفحة الورشة هنا...">{{ old('content') }}</textarea>
                        @error('content')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="mt-4 d-flex gap-2">
                    <button type="submit" class="btn btn-primary">
                        <i class="ti ti-device-floppy me-1"></i> حفظ الورشة
                    </button>
...
@push('scripts')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            var map = L.map('coordinateMap').setView([defaultLat, defaultLng], 14);
            ...
            // Click on map → update marker + inputs
